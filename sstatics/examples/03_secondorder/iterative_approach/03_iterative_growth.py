"""
Example 03:
Show the iterative growth between iteration steps
...
determine the iterative growth according to this approach between iteration
steps.
"""
...
sec_order.iterative_approach(iterations=iteration_steps, tolerance=tolerance,
                             result_type='incremental')

# 7. Get the iterative growth of a chosen iteration step and result
iterative_growth_forces_inital = sec_order.results_iterative_growth(
    0, 'internal_forces')
iterative_growth_forces_last = sec_order.results_iterative_growth(
    -1, 'internal_forces')

print("=== Second Order Example ===")
print(f"Iterative growth of the interal forces of the inital iteration:\n "
      f"{iterative_growth_forces_inital}")
print(f"Iterative growth of the interal forces of the last iteration:\n "
      f"{iterative_growth_forces_last}")
